...
const Notes = () => {
  return (
    ...
    >
        <Select placeholder='Select Class'>
            <Select.Option value="chapter1">Chapter 8</Select.Option>
            <Select.Option value="chapter9">Chapter 9</Select.Option>
            <Select.Option value="chapter10">Chapter 10</Select.Option>
            <Select.Option value="chapter10">Chapter 10</Select.Option>
            <Select.Option value="chapter10">Chapter 10</Select.Option>
        </Select>
    </Form.Item>
