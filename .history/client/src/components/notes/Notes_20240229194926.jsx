    ...
    <div className='notes-container'>
        ...
        <Form
            ...
            >
                <Select placeholder='Select Class'>
                    <Select.Option value="class8" style={{ width: '1200px' }} >Class 8</Select.Option>
        ...
        <Space direction="vertical" size={16}>
            ...
            <div className='notes-upload-container'>
                <Card size="small" title="Material" style={{ width: 300 }}>
            ...
            <div className='notes-upload-container'>
                <Card size="small" title="Link" style={{ width: 300 }}>
                    <FaLink size={22}/>
