  ...
  return (
    <div className='attendance-main'>
        ...
        >
            ...
            <div>
                <Form.Item label="Sub" style={{width: '95%' }} rules={[{ required: true, message: 'Please select class!' }]}>
                    <div>
                        <DatePicker onChange={onChangeDate} style={{width: '95%' }} />
                    </div>
                    <div>
                        <TimePicker type='time' onChange={onChangeTime} style={{width: '95%' }}/>
                    </div>
                </Form.Item>
            </div>
