  ...
  return (
    <div className='attendance-main'>
        ...
        <Form
            ...
            autoComplete="off"
        >
        <div className='attendance-class-inputs-co'>
            <div className='attendance-class-each'>
                <Form.Item label="Class" style={{width: '80%' }} rules={[{ required: true, message: 'Please select class!' }]}>
            ...
            <div className='attendance-class-each'>
                <Form.Item label="Sub" style={{width: '90%' }} rules={[{ required: true, message: 'Please select class!' }]}>
                    <div>
                        <DatePicker onChange={onChangeDate} style={{width: '92%' }} />
                    </div>
                    <div>
                        <TimePicker type='time' onChange={onChangeTime} style={{width: '92%' }}/>
                    </div>
                </Form.Item>
            </div>
        </div>
