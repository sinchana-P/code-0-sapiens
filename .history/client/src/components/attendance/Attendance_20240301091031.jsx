...
const Attendance = () => {
    ...
    const [stdClass, setStdClass] = useState('class8')
        ...
        <div>
            ...
            <div className='attendance-class-inputs-container'>
                ...
                <div className='attendance-class-each'>
                    ...
                    <Select placeholder="Class" onChange={e => setStdClass(e.target.value)}>
                ...
                <div className='attendance-class-each'>
                    ...
                    <Select placeholder="Subject" onChange={value => setSubject(e.target.value)}>
