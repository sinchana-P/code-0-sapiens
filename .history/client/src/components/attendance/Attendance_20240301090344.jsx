...
const Attendance = () => {
    ...
    const onSubmit = () => {
        ...
        console.log(className, subject, date, time)
        ...
        <div>
            ...
            <div className='attendance-class-inputs-container'>
                ...
                <div className='attendance-class-each'>
                    <Form.Item label="className" style={{width: '200px' }} rules={[{ required: true, message: 'Please select class!' }]}>
                    <Select placeholder="class" name='className' onChange={e => setClassName(e.target.value)} value={className}>
